...
function Step({
  ...
  return (
    <div className="flex flex-col rounded-2xl border border-slate-200/60 bg-white/75 p-7 backdrop-blur-sm dark:border-slate-700/50 dark:bg-slate-900/70">
      <div className="mb-4 flex items-center gap-3">
        <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-slate-900 text-xs font-semibold text-white dark:bg-blue-600">
          {n}
        </span>
      ...
      <ul className="mt-4 space-y-2">
        {items.map((item) => (
          <li key={item} className="flex items-start gap-2 text-sm text-slate-600 dark:text-slate-300">
            <svg className="mt-0.5 h-4 w-4 flex-shrink-0 text-blue-600 dark:text-blue-400" viewBox="0 0 16 16" fill="none">
...
export default function LandingPage() {
  return (
    <div className={`${serif.variable} min-h-screen`}>
      {/* Nav */}
      <header className="sticky top-0 z-30 border-b border-slate-200/50 bg-white/70 backdrop-blur-xl dark:border-slate-700/50 dark:bg-slate-950/75">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          <div className="flex items-center gap-3">
            <span className="rounded-full bg-slate-900 px-3 py-1 text-sm font-semibold uppercase tracking-widest text-white dark:bg-white dark:text-slate-900">
              Ora
            </span>
      ...
      <main>
        ...
        <section className="mx-auto max-w-4xl px-6 pb-20 pt-20 text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200/80 bg-blue-50/70 px-4 py-1.5 text-xs font-medium text-blue-700 dark:border-blue-800/60 dark:bg-blue-950/50 dark:text-blue-400">
            <span className="h-1.5 w-1.5 rounded-full bg-blue-500 dark:bg-blue-400"></span>
            University of Washington · CSE
          </div>

          <h1
            className="text-5xl leading-[1.1] tracking-tight text-slate-900 dark:text-white sm:text-6xl md:text-7xl"
            style={{ fontFamily: "var(--font-display)" }}
          >
            Know if your students
            <br />
            <span className="text-blue-700 dark:text-blue-400">understand</span> their code.
          </h1>

          <p className="mx-auto mt-7 max-w-2xl text-lg leading-relaxed text-slate-500 dark:text-slate-400">
            Manual oral check-ins don&apos;t scale past 40 students. Ora automates a structured
            AI comprehension interview for every submission — and gives you a graded report to review.
          </p>
        ...
        {/* Stats strip */}
        <section className="border-y border-slate-200/50 bg-white/50 backdrop-blur-sm dark:border-slate-700/50 dark:bg-slate-900/40">
          <div className="mx-auto max-w-5xl px-6 py-12">
            <div className="grid grid-cols-1 gap-8 text-center sm:grid-cols-3">
              <div>
                <p className="text-4xl font-semibold text-slate-900 dark:text-white">200+</p>
                <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">Students per CS section</p>
              </div>
              <div className="sm:border-x border-slate-200 dark:border-slate-700">
                <p className="text-4xl font-semibold text-slate-900 dark:text-white">2 roles</p>
                <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">Professor · Student</p>
              </div>
              <div>
                <p className="text-4xl font-semibold text-slate-900 dark:text-white">Human-in-loop</p>
                <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">AI suggests — instructor grades</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="how-it-works" className="mx-auto max-w-5xl px-6 py-20">
          <div className="mb-12 text-center">
            ...
            <h2
              className="text-3xl text-slate-900 dark:text-white sm:text-4xl"
              style={{ fontFamily: "var(--font-display)" }}
            >
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <Step
              ...
              description="Submit code and answer questions from an AI interviewer grounded in your actual submission. A report is auto-generated for your professor to review."
              items={[
                "Paste or upload your code",
                "AI asks targeted questions",
                "Professor reviews your report",
              ]}
            />
          </div>
        </section>
        ...
        <section className="mx-auto max-w-5xl px-6 pb-16">
          <div className="rounded-2xl border border-blue-100 bg-blue-50/60 p-8 backdrop-blur-sm dark:border-blue-900/40 dark:bg-blue-950/30 md:p-12">
            <div className="grid gap-8 md:grid-cols-2 md:gap-16">
              <div>
                ...
                <h3
                  className="text-2xl text-slate-900 dark:text-white sm:text-3xl"
                  style={{ fontFamily: "var(--font-display)" }}
                >
                  AI that asks the right questions
                </h3>
                <p className="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                  Every question is grounded in the student&apos;s actual submitted code — so
                  generic answers don&apos;t slip through. The interviewer probes understanding,
                  not just recall.
                </p>
              </div>
              <div>
                ...
                <p className="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                  Each report maps rubric criteria to evidence from the transcript with direct
                  quotes. You see why a score was suggested — and you always make the final call.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mx-auto max-w-5xl px-6 pb-24">
          <div className="relative overflow-hidden rounded-2xl bg-slate-900 px-8 py-16 text-center dark:bg-slate-800 md:px-16">
            <div
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-4 max-w-md text-sm leading-relaxed text-slate-400">
                Sign in with your UW Google account. Professors set up assignments; students complete interviews.
              </p>
              <Link
                href="/login"
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200/50 bg-white/50 backdrop-blur-sm dark:border-slate-700/50 dark:bg-slate-950/50">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
          <div className="flex items-center gap-2.5">
            <span className="rounded-full bg-slate-900 px-2.5 py-0.5 text-xs font-semibold uppercase tracking-widest text-white dark:bg-white dark:text-slate-900">
              Ora
            </span>
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500">UW accounts only</p>
        </div>
      </footer>
    </div>
  );
